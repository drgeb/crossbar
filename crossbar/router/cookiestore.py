...
class CookieStore(object):
    ...
    def create(self):
        ...
        #
        return cbtid, "%s=%s;max-age=%d" % (
            self._cookie_id_field,
            cbtid,
            cbtData["max_age"],
        )
    ...
    def exists(self, cbtid):
        ...
        self.log.debug(
            "Cookie {cbtid} exists = {cookie_exists}",
            cbtid=cbtid,
    ...
    def getAuth(self, cbtid):
        ...
        self.log.debug(
            "Cookie auth info for {cbtid} retrieved: {cookie_auth_info}",
            cbtid=cbtid,
    ...
    def addProto(self, cbtid, proto):
        ...
        """
        self.log.debug(
            "Adding proto {proto} to cookie {cbtid}", proto=proto, cbtid=cbtid
        )
    ...
    def dropProto(self, cbtid, proto):
        ...
        """
        self.log.debug(
            "Removing proto {proto} from cookie {cbtid}", proto=proto, cbtid=cbtid
        )
...
class CookieStoreFileBacked(CookieStore):
    ...
    def _init_store(self):
        ...
        self.log.info(
            "Loaded {cnt_cookie_records} cookie records from file. Cookie store has {cnt_cookies} entries.",
