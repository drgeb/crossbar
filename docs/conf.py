...
copyright_since = "2013"
if this_year != copyright_since:
    copyright = "{0}-{1}, Crossbar.io Technologies GmbH".format(
        copyright_since, this_year
    )
else:
    copyright = "{0}, Crossbar.io Technologies GmbH".format(copyright_since)
